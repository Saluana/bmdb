...
describe("IndexManager - Core Functionality", () => {
  ...
  describe("Document Management", () => {
    ...
    test("should update documents in indexes", () => {
      const oldDoc = { name: "Alice", age: 25, department: "Engineering" };
      const newDoc = { name: "Alice Smith", age: 26, department: "Senior Engineering" };
  ...
  describe("Query Analysis", () => {
    beforeEach(() => {
      ...
      const docs = [
        ...
        { name: "Bob", age: 30, department: "Engineering", salary: 85000 },
        { name: "Charlie", age: 35, department: "Marketing", salary: 65000 },
        { name: "Diana", age: 28, department: "Sales", salary: 70000 },
        { name: "Eve", age: 25, department: "Engineering", salary: 72000 }
      ];
    ...
    test("should analyze complex AND queries", () => {
      const query = where("department").equals("Engineering").and(where("age").greaterThan(25));
      const plan = indexManager.analyzeQuery(query);
    ...
    test("should provide cost estimates", () => {
      ...
      if (simplePlan.useIndex && complexPlan.useIndex) {
        expect(simplePlan.estimatedSelectivity).toBeLessThanOrEqual(complexPlan.estimatedSelectivity);
      }
    });
  });
  ...
  describe("Query Execution", () => {
    ...
    test("should handle IN queries", () => {
      const query = where("department").oneOf(["Engineering", "Marketing"]);
      const plan = indexManager.analyzeQuery(query);
  ...
  describe("Statistics Collection", () => {
    ...
    test("should track string length statistics", () => {
      const docs = [
        ...
        { name: "Alexander", description: "This is a much longer description" }
      ];
  ...
  describe("Index Management", () => {
    ...
    test("should clear all indexes", () => {
      ...
      expect(indexManager.getAvailableIndexes().length).toBeGreaterThan(0);
...
describe("Table Integration with Indexing", () => {
  ...
  beforeEach(() => {
    ...
    table = new Table<TestUser>(storage, "index_test", { enableIndexing: true });
  });
  ...
  describe("Automatic Index Creation", () => {
    test("should create indexes automatically on queries", () => {
      ...
      const results = table.search(where("department").equals("Engineering"));
  ...
  describe("Query Optimization", () => {
    ...
    test("should handle complex queries efficiently", () => {
      const complexQuery = where("department").equals("Engineering")
  ...
  describe("Performance Monitoring", () => {
    ...
    test("should scale with data size", () => {
      ...
      // Large dataset should not be more than 10x slower (with good indexing)
  ...
  describe("Index Maintenance", () => {
    test("should maintain indexes during updates", () => {
      ...
      const results = table.search(where("department").equals("Updated Department"));
    ...
    test("should maintain indexes during deletions", () => {
      ...
      // Trigger index creation
      const initialResults = table.search(where("department").equals("Engineering"));
      ...
      const finalResults = table.search(where("department").equals("Engineering"));
